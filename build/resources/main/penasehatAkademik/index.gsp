                            ...
                            <g:each in="${penasehatAkademik}" var="pa">
                                ...
                                <sec:ifAllGranted roles="ROLE_ADMIN">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="btn btn-danger text-light" href="${createLink(params: [lang:params.lang], id: pa.id, action: 'delete', controller:'penasehatAkademik')}" ><i class="far fa-trash-alt"></i></a>
                                    </td>
                                </sec:ifAllGranted>
                                </tr>
                            </g:each>
