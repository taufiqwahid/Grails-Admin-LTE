                            ...
                            <g:each in="${jurusan}" var="jrs">
                                ...
                                <sec:ifAllGranted roles="ROLE_ADMIN">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="btn btn-danger text-light" onclick="return confirm('${message(code: 'alert.message.delete')}')" href="${createLink(params: [lang:params.lang], id: jrs.id, action: 'delete', controller:'jurusan')}" ><i class="far fa-trash-alt"></i></a>
                                    </td>
                                </sec:ifAllGranted>
                                </tr>
                            </g:each>
